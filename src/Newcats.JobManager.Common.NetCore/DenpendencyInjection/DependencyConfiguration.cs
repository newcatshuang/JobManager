...
using Newcats.JobManager.Api.Infrastructure.Helper.Reflection;
...
namespace Newcats.JobManager.Api.Infrastructure.DenpendencyInjection
{
    public class DependencyConfiguration
    {
        ...
        public DependencyConfiguration(IServiceCollection services, params IConfig[] configs)
        {
            _services = services;
            _configs = configs;
        }
        ...
        private void RegistDependency()
        {
            ...
            //注册Dapper仓储
            _builder.RegisterGeneric(typeof(DataAccess.Repository<,>)).As(typeof(DataAccess.IRepository<,>)).InstancePerLifetimeScope();
        }
